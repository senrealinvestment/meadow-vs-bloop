...
(async function(){
  ...
  try{ var _ap0=document.getElementById("app"); if(_ap0&&_ap0.classList.contains("world-frost")) frostUrl=true; }catch(eCls0){}
  try{
  ...
  var need=["sparkelody/walk/sheet.png","npcs/elder-kid-sheet.png","foes/bloop-fluff-sheet.png"];
  if(frostUrl) need.push("worlds/frost/tiles.png");
  else need.push("worlds/meadow/tiles.png");
  var missing=false;
  ...
  if(frostUrl && frostEmbedMissing){
    ...
    if(frostEmbedMissing) console.error("meadow: frost tiles embed missing on frost URL; holding splash, still eval game");
  } else if(missing){
